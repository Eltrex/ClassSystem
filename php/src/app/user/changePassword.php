...
if($_SESSION["permission"] == "teacher") {
    header("Location: ../teacher/changePassword.php");
    exit();
}
...
if(isset($_POST['change'])) {
    ...
    if($count > 0) {
        ...
        if($new_password == $new_password_repeat) {
            ...
            $stmt = $pdo->prepare("UPDATE students SET PASSWORD = :password, CHANGE_PASSWORD = :change_password WHERE USERNAME = :username");
